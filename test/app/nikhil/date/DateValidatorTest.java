...
public class DateValidatorTest {
    ...
    public void testMonthIsInvalid() {
        DateValidator dateValidator = new DateValidator();
        assertFalse(dateValidator.validator("31/20/2012", "dd/MM/yyyy"));
    }

    @Test
    public void testYearIsInvalid() {
        DateValidator dateValidator = new DateValidator();
        assertFalse(dateValidator.validator("31/20/19991", "dd/MM/yyyy"));
    }

    @Test
    public void testDateFormatIsInvalid() {
        DateValidator dateValidator = new DateValidator();
        assertFalse(dateValidator.validator("2012/02/20", "dd/MM/yyyy"));
    }
